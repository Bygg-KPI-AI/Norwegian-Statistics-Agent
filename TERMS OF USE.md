...
- Availability, functionality, and maintenance are not guaranteed; the agent may be changed or withdrawn at any time.

## Acceptable use and compliance
- You must comply with the terms and usage policies of Statistics Norway (SSB) and any applicable API rate limits and data access restrictions.
- Do not attempt to download excessively large datasets or circumvent platform or API limits.
- Use the agent at your own risk. This is not an official product of Statistics Norway.
...
## Support
- Support is best-effort via GitHub Issues. There is no SLA and no obligation to fix reported issues.
